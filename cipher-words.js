...
let words_36 = [ 'MURDERXMYSTERYXFILEXLOGXDETECTIVEXCA', 'CRIMEXSCENEXINVESTIGATIONXMASTERXLOG', 'CLUEXHUNTERXTRACKINGXCASEXSECRETXFIL', 
        'SECRETXAGENTXMISSIONXFILEXEVIDENCEXL', 'COLDXCASEXFILEXDOCUMENTXTRACKINGXCAS', 'TRAILXLOGXMASTERXREPORTXDETECTIVEXLO', 
        'WITNESSXREPORTXEVIDENCEXHUNTERXMYSTE', 'SLEUTHXFILESXMYSTERYXLOGXCIPHERXCASE', 'PISTOLXEVIDENCEXTRACKERXMISSIONXFILE', 
        'STAKEOUTXMISSIONXDETECTIVEXREPORTXLO', 'FORENSICXPROBEXCASEXLOGXSECRETXFILEX', 'SUSPECTXTRACKERXREPORTXMYSTERYXCASEX', 
        'MOTIVEXHUNTERXSECRETXLOGXEVIDENCEXFI', 'CRIMEXDEDUCTIONXFILEXLOGXTRACKINGXCA', 'EVIDENCEXLOCKERXMYSTERYXREPORTXDETEC', 
        'TRACKINGXAGENTXCASEXFILEXHUNTERXLOGX', 'CIPHERXMESSAGEXDETECTIVEXMYSTERYXCAS', 'DETECTIVEXNOTESXMYSTERYXLOGXREPORTXX', 
        'WARRANXSEARCHXCASEXLOGXEVIDENCEXFILE', 'PROFILEXMASTERXTRACKINGXDETECTIVEXLO', 'CLUESOLVINXMYSTERYXLOGXCIPHERXCASEXX', 
        ...
        'AGENTOPERATESXCASEXLOGXSECRETXXXXXXX', 'SHADOWXTRACKERXMYSTERYXREPORTXXXXXXX', 'REPORTFINDINGXDETECTIVEXLOGXXXXXXXXX', 
        ...
        'PROOFHUNTINGXMYSTERYXDETECTXXXXXXXXX', 'CODEBREAKINGXCASEXLOGXREPORTXXXXXXXX', 'SCANNERREPORTXDETECTIVEXLOGXXXXXXXXX', 
        'BULLETPROOFXMYSTERYXLOGXCASEXXXXXXXX', 'HOLDINGPATTERNXCASEXLOGXFILEXXXXXXXX', 'CLOSEDXCASEXINVESTIGATIONXLOGXXXXXXX', 
